...
public interface grade_cal { // creating interface

    public void grad(int per); // passing parameter
}
---

public class first_demo extends abs_Demo implements grade_cal {

    public static void main(String[] args) {
        // TODO Auto-generated method stub

        first_demo obj=new first_demo(); // creating object for callings the function
        obj.accept();
        obj.calc();
    }
